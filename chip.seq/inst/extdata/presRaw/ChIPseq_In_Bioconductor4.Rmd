---
title: "ChIPseq In Bioconductor (part 4) <html><div style='float:left'></div><hr color='#EB811B' size=1px width=796px></html>"
...
```{r,eval=F,echo=T, eval=T, echo=T, warning=FALSE}
...
```{r,eval=F,echo=T, eval=F, echo=T, warning=FALSE}
library(GenomicAlignments)
