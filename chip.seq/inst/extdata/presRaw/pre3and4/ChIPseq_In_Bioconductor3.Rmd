---
title: "ChIPseq In Bioconductor (part 3) <html><div style='float:left'></div><hr color='#EB811B' size=1px width=796px></html>"
...
In our last session we reviewed how we can [identify putative transciption factor binding sites using peak calling programs such as MACS2.](https://rockefelleruniversity.github.io/RU_ChIPseq/presentations/slides/ChIPseq_In_Bioconductor2.html#37).
